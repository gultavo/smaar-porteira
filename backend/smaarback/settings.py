...
# [CORRIGIDO] Ordem correta do middleware:
#   1. SecurityMiddleware — sempre primeiro
#   2. CorsMiddleware — antes do CommonMiddleware (requisito do django-cors-headers)
#   3. CommonMiddleware — uma única vez (estava duplicado antes)
MIDDLEWARE = [
...
WSGI_APPLICATION = 'smaarback.wsgi.application'
